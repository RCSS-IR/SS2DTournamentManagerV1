...
var table_full = document.getElementById('upload-table');
var table_body = document.getElementById('upload-table-body');
var search_input = document.getElementById('upload-search');
...
function populateTable() {
  ...
  for (let data of tableData) {
    ...
    let upload_date = row.insertCell(2);
    upload_date.innerHTML = data.uploaddate;

    let status = row.insertCell(3);
    status.innerHTML = data.status;

    let active = row.insertCell(4);
    active.innerHTML = data.active;
    row.id = 'row'+data.active

    let last_update = row.insertCell(5);
    last_update.innerHTML = data.lastupdatedate;
